USE master;
GO
IF EXISTS (select * from sys.databases where name = 'CPL_db')
BEGIN 
	ALTER DATABASE CPL_db SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    	DROP DATABASE CPL_db
    	PRINT 'DROP DATABASE CPL_db'
END
    	CREATE DATABASE CPL_db;
    	PRINT 'CREATE DATABASE CPL_db'
...
CREATE TABLE VENDOR (
	...
	VENDOR_PROVINCE		CHAR(2),
	VENDOR_ZIP			VARCHAR(20),
	VENDOR_COUNTRY		VARCHAR(255),
	VENDOR_PHONE		VARCHAR(50),		
	VENDOR_CONTACT		VARCHAR(255),
	VENDOR_DESCRIPT		VARCHAR(255),
	VENDOR_EMAIL		VARCHAR(255),
	VENDOR_STATUS		VARCHAR(100) NOT NULL CHECK (VENDOR_STATUS in ('Approved','Pending Approval','Unapproved')),
	PRIMARY KEY (VENDOR_ID)
	);

CREATE TABLE CONTRACT(
	VENDOR_ID			INT,
	CONTRACT_ID			CHAR(7) NOT NULL UNIQUE,
...
CREATE TABLE PURCHASE_ORDER (
	PURCHASE_ORDER_ID			CHAR(9)	NOT NULL UNIQUE,
...
CREATE TABLE ORDER_ITEM(
	...
	PURCHASE_ORDER_ID			CHAR(9) NOT NULL,
	ORDER_ITEM_QUAN		INT,
...
CREATE TABLE DONOR (
	...
	DONOR_LNAME VARCHAR(255),
	DONOR_FNAME VARCHAR(255),
	DONOR_PHONE VARCHAR(30),
	DONOR_EMAIL VARCHAR(255),
	DONOR_REASON VARCHAR(255),
	PRIMARY KEY (PAY_SOURCE_ID),
...
INSERT INTO PURCHASE_ORDER (PURCHASE_ORDER_ID,VENDOR_ID,EMPLOYEE_ID,PURCHASE_ORDER_DATE)
	VALUES
...
INSERT INTO ORDER_ITEM (PRODUCT_ID, PURCHASE_ORDER_ID,ORDER_ITEM_QUAN)
	VALUES
	...
	('CM656432','ORD100006',1),
	('CM689885','ORD100001',2),
	('ST589743','ORD100014',1),
...
INSERT INTO INVOICE (INVOICE_ID,EMPLOYEE_ID,PURCHASE_ORDER_ID,VENDOR_ID,INVOICE_AMT,INVOICE_RECEIPT,INVOICE_INPUT_DATE,INVOICE_DUE_DATE,INVOICE_STATUS,INVOICE_DATE)
	VALUES
