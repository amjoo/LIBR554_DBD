...
--Query 4 Top 5 Vendors, but date range 

SELECT TOP(5) v.VENDOR_NAME, t.TOTAL_AMT
FROM VENDOR v
JOIN (
	SELECT i.VENDOR_ID, SUM(i.INVOICE_AMT) AS TOTAL_AMT
	FROM INVOICE i
	WHERE DATEADD(MONTH, 1, i.INVOICE_DATE) > GETDATE()
